...
#include <ackermann_msckf/TrackingInfo.h>
...
ImageProcessorAckermann::ImageProcessorAckermann(ros::NodeHandle& n) :
  nh(n),
  is_first_img(true),
  stereo_sub(10),
...
ImageProcessorAckermann::~ImageProcessorAckermann() {
  destroyAllWindows();
  return;
}
 ...
 *
 */
bool ImageProcessorAckermann::loadParameters() {
  ...
  cv::Mat     T_cam0_imu = CvMat2CvMatInverse(T_imu_cam0);
  ...
  cv::Mat     T_cam1_imu = CvMat2CvMatInverse(T_imu_cam1);
 ...
 *
 */
bool ImageProcessorAckermann::createRosIO() {
  ...
  stereo_sub.registerCallback(&ImageProcessorAckermann::stereoCallback, this);
  imu_sub = nh.subscribe("imu", 50,
      &ImageProcessorAckermann::imuCallback, this);
  return true;
}
 ...
 *
 */
bool ImageProcessorAckermann::initialize() {
 ...
 *
 */
void ImageProcessorAckermann::stereoCallback(
 ...
 *
 */
void ImageProcessorAckermann::imuCallback(
 ...
 *
 */
void ImageProcessorAckermann::createImagePyramids() {
 ...
 *
 */
void ImageProcessorAckermann::initializeFirstFrame() {
  // Size of each grid.
  ...
  for (auto& item : grid_new_features)
    std::sort(item.second.begin(), item.second.end(),
        &ImageProcessorAckermann::featureCompareByResponse);
 ...
 *
 */
void ImageProcessorAckermann::predictFeatureTracking(
 ...
 *
 */
void ImageProcessorAckermann::trackFeatures() {
  // Size of each grid.
  ...
  Matx33f cam0_R_p_c;
  Matx33f cam1_R_p_c;
  Eigen::Vector3d cam0_t_p_c;
  Eigen::Vector3d cam1_t_p_c;
 ...
 *
 */
void ImageProcessorAckermann::stereoMatch(
 ...
 *
 */
void ImageProcessorAckermann::addNewFeatures() {
  ...
  for (auto& item : new_feature_sieve) {
    if (item.size() > processor_config.grid_max_feature_num) {
      std::sort(item.begin(), item.end(),
          &ImageProcessorAckermann::keyPointCompareByResponse);
      item.erase(
 ...
 *
 */
void ImageProcessorAckermann::pruneGridFeatures() {
  for (auto& item : *curr_features_ptr) {
    ...
    std::sort(grid_features.begin(), grid_features.end(),
        &ImageProcessorAckermann::featureCompareByLifetime);
...
/**
 * @brief undistortPoints
 *
 */
void ImageProcessorAckermann::undistortPoints(
 ...
 *
 */
vector<cv::Point2f> ImageProcessorAckermann::distortPoints(
    const vector<cv::Point2f>& pts_in,
    const cv::Vec4d& intrinsics,
    const string& distortion_model,
    const cv::Vec4d& distortion_coeffs) {
 ...
 *
 */
void ImageProcessorAckermann::integrateImuData(
 ...
 *
 */
void ImageProcessorAckermann::rescalePoints(
 ...
 *
 */
void ImageProcessorAckermann::twoPointRansac(
 ...
 *
 */
void ImageProcessorAckermann::publish() {
 ...
 *
 */
void ImageProcessorAckermann::drawFeaturesMono() {
 ...
 *
 */
void ImageProcessorAckermann::drawFeaturesStereo() {
...
/**
 * @brief updateFeatureLifetime
 *
 */
void ImageProcessorAckermann::updateFeatureLifetime() {
  for (int code = 0; code <
      processor_config.grid_row*processor_config.grid_col; ++code) {
...
/**
 * @brief featureLifetimeStatistics
 *
 */
void ImageProcessorAckermann::featureLifetimeStatistics() {
