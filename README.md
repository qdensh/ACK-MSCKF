...
ACK-MSCKF [1] is a tightly-coupled Ackermann stereo visual-inertial odometry (VIO) for autonomous vehicle localization based on the famous open source VIO, i.e., S-MSCKF [2].  

1. Ma, F.; Shi, J.; Yang, Y.; Li, J.; Dai, K. ACK-MSCKF: Tightly-Coupled Ackermann Multi-State Constraint Kalman Filter for Autonomous Vehicle Localization. Sensors 2019, 19, 4816, doi:10.3390/s19214816.

2. Sun, K.; Mohta, K.; Pfrommer, B.; Watterson, M.; Liu, S.; Mulgaonkar, Y.; Taylor, C.J.; Kumar, V. Robust stereo visual inertial odometry for fast autonomous flight. IEEE Robot. Autom. Lett. 2018, 3, 965–972, doi:10.1109/LRA.2018.2793349.
