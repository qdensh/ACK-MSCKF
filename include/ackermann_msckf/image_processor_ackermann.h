...
/*
 * @brief ImageProcessorAckermann Detects and tracks features
 *    in image sequences.
 */
class ImageProcessorAckermann {
public:
  // Constructor
  ImageProcessorAckermann(ros::NodeHandle& n);
  // Disable copy and assign constructors.
  ImageProcessorAckermann(const ImageProcessorAckermann&) = delete;
  ImageProcessorAckermann operator=(const ImageProcessorAckermann&) = delete;

  // Destructor
  ~ImageProcessorAckermann();

  // Initialize the object.
  bool initialize();

  typedef boost::shared_ptr<ImageProcessorAckermann> Ptr;
  typedef boost::shared_ptr<const ImageProcessorAckermann> ConstPtr;
...
private:
  ...
  Eigen::Matrix3d   R_cam0_body;
  Eigen::Vector3d   t_cam0_body;
  Eigen::Matrix3d   R_cam1_body;
  Eigen::Vector3d   t_cam1_body;

  Eigen::Matrix3d   R_cam0_imu_;
  Eigen::Vector3d   t_cam0_imu_;
  Eigen::Matrix3d   R_cam1_imu_;
  Eigen::Vector3d   t_cam1_imu_;
...
typedef ImageProcessorAckermann::Ptr ImageProcessorAckermannPtr;
typedef ImageProcessorAckermann::ConstPtr ImageProcessorAckermannConstPtr;
